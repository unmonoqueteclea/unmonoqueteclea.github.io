#+title: Do you still ssh into remote machines just to check Docker logs?
#+date: <2023-02-18 21:46>
#+description:
#+filetags: docker

A single, local, *Docker CLI* is the only thing you need to manage
multiple Docker nodes. Let me show you a little example.
