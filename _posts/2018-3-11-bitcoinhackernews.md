...
nos centraremos en un ejemplo concreto en el que intentaremos ver la
...
![Crisis de los tulipanes](../../assets/images/tulipo.png){:class="img-responsive center-image"}


Sin embargo, no todo el mundo es tan negativo respecto a las
criptomonedas. Existe quien lo considera una **auténtica revolución**
que ha venido para quedarse. Por sus características, **los modelos de
la economía tradicional no nos sirven de nada con las criptomonedas**
y habría que incorporar nuevos factores a las
...
son falsas. Cualquier noticia relacionada con las criptomonedas afecta
a la **confianza de los inversores** y tiene efectos directos en el
precio del Bitcoin. Por ello, en este artículo nos hemos propuesto ver
cómo se relaciona la cantidad de noticias sobre Bitcoin con el precio
del mismo.

## ¿Qué es Kaggle?
Para el análisis de los datos en este artículo usaremos
**Kaggle**. Todo aficionado a la ciencia de datos debería conocer
Kaggle. Kaggle surge en 2010 como una plataforma para la realización
de competiciones de análisis y visualización de datos.

![Kaggle](../../assets/images/kaggle.png){:class="img-responsive center-image"}
...
fácilmente pueden llegar hasta los cien mil dólares, Kaggle dispone de
una gran cantidad de **datasets**, **foros** muy activos, **ranking**
de usuarios e incluso un apartado donde empresas del sector publican
**ofertas de trabajo**.
...
![Kaggle Kernels](../../assets/images/kernels.jpg){:class="img-responsive center-image"}
...
convirtiéndolos en la herramienta perfecta para la divulgación.

## ¿Y BigQuery?
**BigQuery** es un servicio de Big Data de Google que permite realizar
consultas, con una sintaxis muy similar a la de SQL, sobre inmensos
conjuntos de datos de varios terabytes en apenas segundos. [La
tecnología que subyace a Google BigQuery, es
...
en apenas 10 segundos. **BRUTAL**. Es la herramienta perfecta para
usar como **Data Warehouse**. Si hacemos consultas a BigQuery desde
Kaggle, **podremos analizar hasta 5TB de datos al mes de forma
totalmente gratuita**.

![BigQuery](../../assets/images/bigquery.png){:class="img-responsive center-image"}
...
News](https://cloud.google.com/bigquery/public-data/hacker-news#about_the_data).

![Hacker News](../../assets/images/hacker-news.jpg){:class="img-responsive center-image"}

HackerNews es un portal web donde los usuarios recopilan y comentan
las principales noticias relacionadas con tecnología y
...
![Kaggle Dataset](../../assets/images/kaggledataset.jpg){:class="img-responsive center-image"}
...
nuestro Kernel que queremos usar ese dataset.  {: .notice--info}
...
![Wordcloud](../../assets/images/btcwordcloud.png){:class="img-responsive center-image"}
...
Diciembre. Pocos días después, el precio del Bitcoin se desplomó sin
causa aparente. En la siguiente imagen vemos el intervalo de tiempo
del que hablo:

![BTC](../../assets/images/noviembreBTC.jpg){:class="img-responsive center-image"}
